...
fn cs( @builtin(global_invocation_id) _cell:vec3u ) {
  ...
  if( (activeNeighbors == 3.0 || activeNeighbors == 6.0 || activeNeighbors == 7.0 || activeNeighbors == 8.0) && cell_alive == 0.0 ) {
    stateout[i] = 1.0;
  }else if( (activeNeighbors == 3.0 || activeNeighbors == 4.0 || activeNeighbors == 6.0 || activeNeighbors == 7.0 || activeNeighbors == 8.0) && cell_alive == 1.0 ) {
    stateout[i] = 1.0;
  }else{
    stateout[i] = 0.;
  }
